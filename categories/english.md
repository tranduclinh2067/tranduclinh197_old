...
<div class="container bg-light container-border-radius py-3 px-4 my-lg-4 my-3">
    <div class="posts">
        ...
        <div class="card-columns col-md-12 ">
            {% for english in site.categories.english %}
                <div class="card shadow-sm mt-5">
                    <div class="card-header bg-transparent border-0" style="margin-bottom: -44px;">
                        <a href="{{ english.url | prepend: site.baseurl }}">
                            <img title="{{ english.title }}" class="card-position img container-border-radius shadow hover-img" src="{{ english.img-title }}" width="100%">
                        </a>
                    </div>
                    <div class="card-body">
                        <h5 class="text-center"><a title="{{ english.title }}" href="{{ english.url }}">{{ english.title }}</a></h5>
                        {% if english.tag != null %}
                            <i class="fas fa-tags font-weight-light mr-lg-1">
                                {% for multi-tag in english.tag %}
