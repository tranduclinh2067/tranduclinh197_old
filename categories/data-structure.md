...
<div class="container bg-light container-border-radius py-3 px-4 my-lg-4 my-3">
    <div class="posts">
        ...
        <div class="card-columns col-md-12 ">
            {% for data-structure in site.categories.data-structure %}
                <div class="card shadow-sm mt-5">
                    <div class="card-header bg-transparent border-0" style="margin-bottom: -44px;">
                        <a href="{{ data-structure.url | prepend: site.baseurl }}">
                            <img title="{{ data-structure.title }}" class="card-position img container-border-radius shadow hover-img" src="{{ data-structure.img-title }}" width="100%">
                        </a>
                    </div>
                    <div class="card-body">
                        <h5 class="text-center"><a title="{{ data-structure.title }}" href="{{ data-structure.url }}">{{ data-structure.title }}</a></h5>
                        {% if data-structure.tag != null %}
                            <i class="fas fa-tags font-weight-light mr-lg-1">
                                {% for multi-tag in data-structure.tag %}
                    ...
                    <div class="card-footer border-0 bg-transparent d-flex justify-content-around">
                        ...
                        <i class="fas fa-clock font-weight-light mr-lg-1">
                            <a href="#">
                                <span>
                                    <small>
                                        {{ data-structure.date | date_to_string }}
                                    </small>
                                </span>
                            </a>
                        </i>
